...
from charmhelpers.commandant import signature
...
class FunctionSignatureTest(TestCase):
    ...
    def test_positional_arguments(self):
        ...
        argparams = signature.describe_arguments(lambda x, y, z: False)
        self.assertEqual(tuple(argparams),
                ((('x',), {}), (('y',), {}), (('z',), {})))

    def test_keyword_arguments(self):
        """Function has optional parameters with default values."""
        argparams = tuple(signature.describe_arguments(
    ...
    def test_keyword_splat_missing(self):
        ...
        of commandant."""
        args = signature.describe_arguments(
