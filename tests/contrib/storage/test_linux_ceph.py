...
class CephUtilsTests(TestCase):
    ...
    def test_insert_key(self, _exists):
        """It creates a new ceph keyring"""
        _exists.return_value = False
        ceph_utils.insert_key('cinder', 'cephkey')
    ...
    @patch('os.path.exists')
    def test_insert_key_already_exists(self, _exists):
    ...
    @patch('os.path.exists')
    def test_insert_key_already_exists_and_key_exists(self, _exists):
    ...
    def test_configure(self):
        ...
        self.insert_key.assert_called_with('cinder', 'key')
    ...
    @patch.object(ceph_utils, 'insert_key')
    @patch.object(ceph_utils, 'relation_ids')
