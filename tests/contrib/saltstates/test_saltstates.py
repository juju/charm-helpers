...
import charmhelpers.contrib.saltstates
...
class InstallSaltSupportTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = mock.patch('charmhelpers.contrib.saltstates.subprocess')
    ...
    def test_adds_ppa_by_default(self):
        charmhelpers.contrib.saltstates.install_salt_support()
...
class UpdateMachineStateTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = mock.patch('charmhelpers.contrib.saltstates.'
                             'juju_config_2_grains')
        self.mock_config_2_grains = patcher.start()
        self.addCleanup(patcher.stop)

    def test_calls_local_salt_template(self):
        charmhelpers.contrib.saltstates.update_machine_state(
            'states/install.yaml')
...
class JujuConfig2GrainsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        patcher = mock.patch.object(charmhelpers.contrib.saltstates,
    ...
    def test_output_without_relation(self):
        ...
        charmhelpers.contrib.saltstates.juju_config_2_grains()
